...
import net.irisshaders.firis.shaderpack.option.OptionAnnotatedSource;
...
public class OptionApplyTest {
	...
	void testOptions() {
		...
		try {
			shaderPack = new ShaderPack(FirisTests.getTestShaderPackPath("options"), FirisTests.TEST_ENVIRONMENT_DEFINES);
		} catch (Exception e) {
