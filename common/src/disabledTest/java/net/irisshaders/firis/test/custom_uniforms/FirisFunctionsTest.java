package net.irisshaders.firis.test.custom_uniforms;
...
public class FirisFunctionsTest {
	private static void trivialTest(Type outputType, String expressionStr, Consumer<FunctionReturn> verifier) throws ParseException {
		ExpressionElement element = Parser.parse(expressionStr, FirisOptions.options);
		ExpressionResolver resolver = new ExpressionResolver(FirisFunctions.functions, x -> {
