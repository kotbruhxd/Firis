package net.irisshaders.firis.compat.sodium.impl.vertex_format.entity_xhfp;
...
import net.caffeinemc.mods.fodium.api.util.NormI8;
...
public final class EntityVertex {
	public static final VertexFormatDescription FORMAT = VertexFormatRegistry.instance().get(FirisVertexFormats.ENTITY);
	public static final int STRIDE = FirisVertexFormats.ENTITY.getVertexSize();
