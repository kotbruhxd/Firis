...
import net.irisshaders.firis.compat.sodium.impl.vertex_format.entity_xhfp.QuadViewEntity;
...
public class GlyphExtVertexSerializer implements VertexSerializer {
	...
	private static void endQuad(float uSum, float vSum, long src, long dst) {
		...
		quad.setup(src, FirisVertexFormats.GLYPH.getVertexSize());
	...
	public void serialize(long src, long dst, int vertexCount) {
		...
		for (int i = 0; i < vertexCount; i++) {
			...
			dst += FirisVertexFormats.GLYPH.getVertexSize();
		}
