...
public final class GlyphVertexExt {
	public static final VertexFormatDescription FORMAT = VertexFormatRegistry.instance().get(FirisVertexFormats.GLYPH);
	public static final int STRIDE = FirisVertexFormats.GLYPH.getVertexSize();
