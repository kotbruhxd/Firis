package net.irisshaders.firis.compat.sodium.impl.vertex_format.terrain_xhfp;

import net.caffeinemc.mods.fodium.client.gl.attribute.GlVertexAttributeFormat;
import net.caffeinemc.mods.fodium.client.gl.attribute.GlVertexFormat;
...
import net.irisshaders.firis.compat.sodium.impl.vertex_format.FirisGlVertexAttributeFormat;

/**
 * Like HFPModelVertexType, but extended to support Firis. The extensions aren't particularly efficient right now.
 */
public class XHFPModelVertexType implements ChunkVertexType {
	...
	public static final GlVertexFormat<ChunkMeshAttribute> VERTEX_FORMAT = GlVertexFormat.builder(ChunkMeshAttribute.class, STRIDE)
		...
		.addElement(FirisChunkMeshAttributes.MID_TEX_COORD, 20, GlVertexAttributeFormat.UNSIGNED_SHORT, 2, false, false)
		.addElement(FirisChunkMeshAttributes.TANGENT, 24, FirisGlVertexAttributeFormat.BYTE, 4, true, false)
		.addElement(FirisChunkMeshAttributes.NORMAL, 28, FirisGlVertexAttributeFormat.BYTE, 3, true, false)
		.addElement(FirisChunkMeshAttributes.BLOCK_ID, 32, FirisGlVertexAttributeFormat.SHORT, 2, false, false)
		.addElement(FirisChunkMeshAttributes.MID_BLOCK, 36, FirisGlVertexAttributeFormat.BYTE, 4, false, false)
		.build();
