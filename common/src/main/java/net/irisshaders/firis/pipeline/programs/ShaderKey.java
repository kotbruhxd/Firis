...
public enum ShaderKey {
	...
	CLOUDS_SODIUM(ProgramId.Clouds, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.CLOUDS, FogMode.PER_FRAGMENT, LightingModel.LIGHTMAP),
	TERRAIN_SOLID(ProgramId.TerrainSolid, AlphaTests.OFF, FirisVertexFormats.TERRAIN, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	TERRAIN_CUTOUT(ProgramId.TerrainCutout, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.TERRAIN, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	TERRAIN_TRANSLUCENT(ProgramId.Water, AlphaTests.OFF, FirisVertexFormats.TERRAIN, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	MOVING_BLOCK(ProgramId.Block, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.TERRAIN, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	ENTITIES_ALPHA(ProgramId.Entities, AlphaTests.VERTEX_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	ENTITIES_SOLID(ProgramId.Entities, AlphaTests.OFF, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	ENTITIES_SOLID_DIFFUSE(ProgramId.Entities, AlphaTests.OFF, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	ENTITIES_SOLID_BRIGHT(ProgramId.Entities, AlphaTests.OFF, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	ENTITIES_CUTOUT(ProgramId.Entities, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	ENTITIES_CUTOUT_DIFFUSE(ProgramId.Entities, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	ENTITIES_TRANSLUCENT(ProgramId.EntitiesTrans, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	ENTITIES_EYES(ProgramId.SpiderEyes, AlphaTests.NON_ZERO_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	ENTITIES_EYES_TRANS(ProgramId.SpiderEyes, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	HAND_CUTOUT(ProgramId.Hand, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	HAND_CUTOUT_BRIGHT(ProgramId.Hand, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	HAND_CUTOUT_DIFFUSE(ProgramId.Hand, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	HAND_TEXT(ProgramId.Hand, AlphaTests.NON_ZERO_ALPHA, FirisVertexFormats.GLYPH, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	HAND_TEXT_INTENSITY(ProgramId.Hand, AlphaTests.NON_ZERO_ALPHA, FirisVertexFormats.GLYPH, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	HAND_TRANSLUCENT(ProgramId.HandWater, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	HAND_WATER_BRIGHT(ProgramId.HandWater, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	HAND_WATER_DIFFUSE(ProgramId.HandWater, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	...
	CRUMBLING(ProgramId.DamagedBlock, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.TERRAIN, FogMode.OFF, LightingModel.FULLBRIGHT),
	TEXT(ProgramId.EntitiesTrans, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.GLYPH, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	TEXT_INTENSITY(ProgramId.EntitiesTrans, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.GLYPH, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	TEXT_BE(ProgramId.BlockTrans, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.GLYPH, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	TEXT_INTENSITY_BE(ProgramId.BlockTrans, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.GLYPH, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	BLOCK_ENTITY(ProgramId.Block, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	BLOCK_ENTITY_BRIGHT(ProgramId.Block, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	BLOCK_ENTITY_DIFFUSE(ProgramId.Block, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	BE_TRANSLUCENT(ProgramId.BlockTrans, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	...
	SHADOW_TERRAIN_CUTOUT(ProgramId.Shadow, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.TERRAIN, FogMode.OFF, LightingModel.LIGHTMAP),
	SHADOW_ENTITIES_CUTOUT(ProgramId.Shadow, AlphaTests.ONE_TENTH_ALPHA, FirisVertexFormats.ENTITY, FogMode.OFF, LightingModel.LIGHTMAP),
	...
	SHADOW_TEXT(ProgramId.Shadow, AlphaTests.NON_ZERO_ALPHA, FirisVertexFormats.GLYPH, FogMode.OFF, LightingModel.LIGHTMAP),
	...
	SHADOW_TEXT_INTENSITY(ProgramId.Shadow, AlphaTests.NON_ZERO_ALPHA, FirisVertexFormats.GLYPH, FogMode.OFF, LightingModel.LIGHTMAP),
