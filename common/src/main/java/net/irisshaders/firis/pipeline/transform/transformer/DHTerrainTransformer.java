...
import static net.irisshaders.firis.pipeline.transform.transformer.CommonTransformer.addIfNotExists;
...
public class DHTerrainTransformer {
	public static void transform(
		...
		if (parameters.type.glShaderType == ShaderType.VERTEX) {
			...
			// See https://github.com/FirisShaders/Firis/issues/1149
		...
		Firis.logger.warn("Type is " + parameters.type);
