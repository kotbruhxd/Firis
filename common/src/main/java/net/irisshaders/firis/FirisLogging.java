...
public class FirisLogging {
	public static boolean ENABLE_SPAM = false; // FirisPlatformHelpers.getInstance().isDevelopmentEnvironment();

	private final Logger logger;

	public FirisLogging(String loggerName) {
