package net.irisshaders.firis.samplers;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableSet;
import it.unimi.dsi.fastutil.objects.Object2ObjectMap;
import net.irisshaders.firis.gl.image.GlImage;
import net.irisshaders.firis.gl.sampler.GlSampler;
...
public class FirisSamplers {
	...
	public static void addRenderTargetSamplers(SamplerHolder samplers, Supplier<ImmutableSet<Integer>> flipped,
		...
		// Firis could lift this restriction, though I'm not sure if it could cause issues.
	...
	public static boolean hasShadowSamplers(SamplerHolder samplers) {
		...
		for (int i = 0; i < PackShadowDirectives.MAX_SHADOW_COLOR_BUFFERS_FIRIS; i++) {
