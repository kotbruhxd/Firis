package net.irisshaders.firis.uniforms.custom;
...
import net.irisshaders.firis.gl.uniform.UniformType;
import net.irisshaders.firis.gl.uniform.UniformUpdateFrequency;
import net.irisshaders.firis.uniforms.custom.cached.BooleanCachedUniform;
import net.irisshaders.firis.uniforms.custom.cached.CachedUniform;
import net.irisshaders.firis.uniforms.custom.cached.Float2VectorCachedUniform;
import net.irisshaders.firis.uniforms.custom.cached.Float3VectorCachedUniform;
import net.irisshaders.firis.uniforms.custom.cached.Float4MatrixCachedUniform;
import net.irisshaders.firis.uniforms.custom.cached.Float4VectorCachedUniform;
import net.irisshaders.firis.uniforms.custom.cached.FloatCachedUniform;
import net.irisshaders.firis.uniforms.custom.cached.Int2VectorCachedUniform;
import net.irisshaders.firis.uniforms.custom.cached.Int3VectorCachedUniform;
import net.irisshaders.firis.uniforms.custom.cached.IntCachedUniform;
	...
	public static class Builder implements UniformHolder {
		...
		private Builder put(String name, CachedUniform uniform) {
			if (inputVariables.containsKey(name)) {
				Firis.logger.warn("Duplicated fixed uniform supplied as inputs to the Custom uniform holder: " + name);
				return this;
			}
