...
public final class IdMapUniforms {
	...
	private static class HeldItemSupplier {
		...
		private void invalidate() {
			intID = -1;
			lightValue = 0;
			lightColor = FirisItemLightProvider.DEFAULT_LIGHT_COLOR;
		}
		...
		public void update() {
			...
			FirisItemLightProvider lightProvider = (FirisItemLightProvider) heldItem;
		...
		private FirisItemLightProvider applyOldHandLighting(@NotNull LocalPlayer player, FirisItemLightProvider existing) {
			...
			FirisItemLightProvider lightProvider = (FirisItemLightProvider) offHandItem;
