package net.irisshaders.firis.gui;
...
public final class GuiUtil {
	public static final ResourceLocation FIRIS_WIDGETS_TEX = new ResourceLocation("firis", "textures/gui/widgets.png");
	...
	/**
	 * Binds Firis's widgets texture to be
	 * used for succeeding draw calls.
	 */
	public static void bindIrisWidgetsTexture() {
		RenderSystem.setShaderTexture(0, FIRIS_WIDGETS_TEX);
	}
	...
	public static void drawButton(GuiGraphics guiGraphics, int x, int y, int width, int height, boolean hovered, boolean disabled) {
		...
		// Top left section
		guiGraphics.blit(FIRIS_WIDGETS_TEX, x, y, 0, vOffset, halfWidth, halfHeight, 256, 256);
		// Top right section
		guiGraphics.blit(FIRIS_WIDGETS_TEX, x + halfWidth, y, 200 - (width - halfWidth), vOffset, width - halfWidth, halfHeight, 256, 256);
		// Bottom left section
		guiGraphics.blit(FIRIS_WIDGETS_TEX, x, y + halfHeight, 0, vOffset + (20 - (height - halfHeight)), halfWidth, height - halfHeight, 256, 256);
		// Bottom right section
		guiGraphics.blit(FIRIS_WIDGETS_TEX, x + halfWidth, y + halfHeight, 200 - (width - halfWidth), vOffset + (20 - (height - halfHeight)), width - halfWidth, height - halfHeight, 256, 256);
	}
	...
	public static class Icon {
		...
		public void draw(GuiGraphics guiGraphics, int x, int y) {
			...
			guiGraphics.blit(FIRIS_WIDGETS_TEX, x, y, u, v, width, height, 256, 256);
		}
