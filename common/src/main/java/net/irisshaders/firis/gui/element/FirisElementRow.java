...
public class FirisElementRow {
	...
	public FirisElementRow(int spacing) {
		this.spacing = spacing;
	}

	public FirisElementRow() {
		this(1);
	}
	 ...
	 */
	public FirisElementRow add(Element element, int width) {
	...
	/**
	 * A clickable button element that uses a {@link net.irisshaders.firis.gui.GuiUtil.Icon} as its label.
	 */
