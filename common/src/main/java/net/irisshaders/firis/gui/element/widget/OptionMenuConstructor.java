package net.irisshaders.firis.gui.element.widget;
...
import net.irisshaders.firis.gui.element.screen.ElementWidgetScreenData;
import net.irisshaders.firis.gui.screen.ShaderPackScreen;
import net.irisshaders.firis.shaderpack.option.menu.OptionMenuBooleanOptionElement;
import net.irisshaders.firis.shaderpack.option.menu.OptionMenuContainer;
import net.irisshaders.firis.shaderpack.option.menu.OptionMenuElement;
import net.irisshaders.firis.shaderpack.option.menu.OptionMenuElementScreen;
import net.irisshaders.firis.shaderpack.option.menu.OptionMenuLinkElement;
import net.irisshaders.firis.shaderpack.option.menu.OptionMenuMainElementScreen;
import net.irisshaders.firis.shaderpack.option.menu.OptionMenuProfileElement;
import net.irisshaders.firis.shaderpack.option.menu.OptionMenuStringOptionElement;
import net.irisshaders.firis.shaderpack.option.menu.OptionMenuSubElementScreen;
...
public final class OptionMenuConstructor {
	...
	static {
		registerScreen(OptionMenuMainElementScreen.class, screen ->
			new ElementWidgetScreenData(Component.literal(Firis.getCurrentPackName()).append(Firis.isFallback() ? " (fallback)" : "").withStyle(ChatFormatting.BOLD), false));
