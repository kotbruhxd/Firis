...
public class FirisVertexFormats {
	...
	private static void debug(VertexFormat format) {
		Firis.logger.info("Vertex format: " + format + " with byte size " + format.getVertexSize());
		int byteIndex = 0;
		for (VertexFormatElement element : format.getElements()) {
			Firis.logger.info(element + " @ " + byteIndex + " is " + element.getType() + " " + element.getUsage());
