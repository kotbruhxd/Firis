...
import net.irisshaders.firis.shaderpack.parsing.ParsedString;
import net.irisshaders.firis.shaderpack.properties.PackShadowDirectives;
import net.irisshaders.firis.shaderpack.transform.line.LineTransform;
...
public final class OptionAnnotatedSource {
	 ...
	 * author may have intended for a line to be a valid option, Firis might have ignored it due to
	 * a syntax error or some other issue.
	 * <p>
	 * These diagnostic messages provide reasons for why Firis decided to ignore a plausible option
