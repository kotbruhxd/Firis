...
import net.irisshaders.firis.helpers.VertexBufferHelper;
...
public class FullScreenQuadRenderer {
	...
	public void renderQuad() {
		FirisRenderSystem.overridePolygonMode();
		quad.draw();
		FirisRenderSystem.restorePolygonMode();
	}
	...
	public void end() {
		...
		// https://github.com/FirisShaders/Firis/issues/1214
