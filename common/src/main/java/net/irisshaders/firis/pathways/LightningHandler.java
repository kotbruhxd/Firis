...
import net.irisshaders.firis.layer.InnerWrappedRenderType;
import net.irisshaders.firis.layer.LightningRenderStateShard;
...
public class LightningHandler extends RenderType {
	public static final RenderType FIRIS_LIGHTNING = new InnerWrappedRenderType("iris_lightning2", RenderType.create(
		"iris_lightning",
