...
public class MixinDirectoryLister {
	...
	private void firis$modifyForEachAction(Map<ResourceLocation, Resource> instance, BiConsumer<? super ResourceLocation, ? super Resource> action, Operation<Void> original, ResourceManager resourceManager) {
