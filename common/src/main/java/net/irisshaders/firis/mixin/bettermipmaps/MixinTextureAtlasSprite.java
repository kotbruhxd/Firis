package net.irisshaders.firis.mixin.bettermipmaps;

import com.mojang.blaze3d.platform.NativeImage;
import net.irisshaders.firis.helpers.ColorSRGB;
...
public class MixinTextureAtlasSprite {
	 ...
	 */
	@Unique
	private static void firis$fillInTransparentPixelColors(NativeImage nativeImage) {
	...
	private void firis$beforeGenerateMipLevels(SpriteContents instance, NativeImage nativeImage, ResourceLocation resourceLocation) {
		...
		firis$fillInTransparentPixelColors(nativeImage);
