...
buildConfig {
    ...
    packageName("net.irisshaders.firis")  // forces the package. Defaults to '${project.group}'
    useJavaOutput()
...
dependencies {
    ...
    modCompileOnly(files(rootDir.resolve("custom_sodium").resolve("fodium-fabric-0.6.0-alpha.3+mc1.20.1.jar")))
...
loom {
    mixin {
        defaultRefmapName = "firis.refmap.json"
        useLegacyMixinAp = false
    }

    accessWidenerPath = file("src/main/resources/firis.accesswidener")
