...
public class MixinParticleEngine implements PhasedParticleEngine {
	...
	private void firis$changeParticleShader(Supplier<ShaderInstance> pSupplier0) {
	...
	private Set<ParticleRenderType> firis$selectParticlesToRender(Map<ParticleRenderType, Queue<Particle>> instance) {
