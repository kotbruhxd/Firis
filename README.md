...
- Firis supports almost all shaderpacks, but a list of unsupported shaderpacks is available [here](docs/unsupportedshaders.md).
...
* **The Fabric and Quilt projects**, for enabling the existence of mods like Firis that make many patches to the game
...
* **All past, present, and future contributors to Firis**, for helping the project move along
* **Dr. Rubisco**, for maintaining the website
* **The Firis support and moderation team**, for handling user support requests and allowing me to focus on developing Firis
