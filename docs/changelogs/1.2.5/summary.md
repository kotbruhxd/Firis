# Firis 1.2.5 Changelog (trimmed)


Firis 1.2.5 is now available for download for Minecraft 1.16.5, 1.17.1, and 1.18.2, fixing a huge number of bugs and mod compatibility issues, massively improving performance with packs using depth of field, and improving performance in some CPU-limited scenarios.
...
- ✅ Added an update checker so that people don't keep on running massively outdated Firis versions
...
A more detailed changelog is available for those interested: <https://github.com/FirisShaders/Firis/blob/trunk/docs/changelogs/1.2.5/full.md>
