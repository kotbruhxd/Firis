# Firis 1.6 Changelog (full)

Firis 1.6 has released for 1.18.2, 1.19.2, and 1.19.4.

This release was developed by IMS.

## Overview

- Added `IS_FIRIS` define to use the following features
- Added SSBO's
...
A new uniform has been added, `currentRenderedItemId`. This is transformed by Firis at runtime, and is an integer corresponding to the current item/piece of armor being rendered, if it exists.
...
- [Update Taiwan Chinese translation](https://github.com/FirisShaders/Firis/pull/1905) (notlin4)
- [Add new translations and improve translation consistency in Polish](https://github.com/FirisShaders/Firis/pull/1883) (bascioTOja)
- [Updating Brazilian Portuguese translations](https://github.com/FirisShaders/Firis/pull/1933) (Draacoun)
- [Updating Korean translations](https://github.com/FirisShaders/Firis/pull/1934) (xphere07)
