# Firis 1.2.0 Changelog

Firis 1.2.0 is here for Minecraft 1.16.5 / 1.17.1 / 1.18.1, bringing the long awaited Shader Configuration GUI!
...
- Added support for the `renderStage` uniform, allows SEUS PTGI HRR 3 to load (IMS)
    - HRR 3 is still not supported and has severe bugs on Firis.
