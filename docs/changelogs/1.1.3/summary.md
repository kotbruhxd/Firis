Firis version 1.1.3 for Minecraft 1.16.5 and Minecraft 1.17.1 has been released!
...
- :fodium: Sodium is no longer bundled, and must be installed separately (The installer still installs it for you)
- 🌄 Firis now fully supports SEUS Renewed, and now has functional support (on some hardware / drivers) for SEUS PTGI & SEUS PTGI HRR
...
- ⚠ Sodium 0.4.0-alpha5 for 1.18 is still in early alpha, meaning that you might run into significant bugs or other issues. Please exercise good issue-reporting skills if you want to report issues with the 1.18 versions of Firis / Sodium.
...
A more detailed changelog is available for those interested: <https://github.com/FirisShaders/Firis/blob/trunk/docs/changelogs/1.1.3/full.md>
