# Firis 1.4 Changelog (full)

Firis 1.4 is now available for download for 1.16.5, 1.18.2, and 1.19.2, adding many OptiFine parity features as well as new features for shader developers.
...
## Feature Flags
Feature flags are a new system in Firis to query the existence of certain features. To activate them use `iris.feature.required` to show an error if your PC or Firis doesn't support a feature.

You can also use `iris.feature.optional` to get a define with the feature name `FIRIS_FEATURE_X`.
...
- [Fixed consistency in French translation](https://github.com/FirisShaders/Firis/pull/1668) (Julienraptor01)
- [Updated Korean translation](https://github.com/FirisShaders/Firis/pull/1688) (xphere07)
- [Updated Traditional Chinese translation](https://github.com/FirisShaders/Firis/pull/1676) (HJ-zhtw)
- [Updated Russian translation](https://github.com/FirisShaders/Firis/pull/1677) (Felix14-v2)
