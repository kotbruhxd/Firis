# Firis 1.2.6 Changelog (full)


Firis 1.2.6 is now available for download, fixing minor bugs and adding support for 1.19.1.
...
- [Updated Slovakian translation](https://github.com/FirisShaders/Firis/pull/1548) (SmajloSlovakian)
