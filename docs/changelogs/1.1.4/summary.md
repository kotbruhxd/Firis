Firis version 1.1.4 for Minecraft 1.16.5, Minecraft 1.17.1, and Minecraft 1.18.1 has been released!
...
This release mainly focuses on bug fixes, and closes over 50 GitHub issues! It resolves a huge number of bugs, and the Firis experience with supported packs should be substantially improved as a result.

In other news, shader configuration is also in the final testing & bug fixing phases, meaning that very soon, official Firis releases will support modifying shaders through a GUI without the need for any 3rd-party forks or workarounds. Stay tuned for more updates on that!
...
- 📈 Fixed a performance drop with shaders disabled compared to base Sodium - Firis with shaders off should no longer measurably decrease performance
...
A more detailed changelog is available for those interested: <https://github.com/FirisShaders/Firis/blob/trunk/docs/changelogs/1.1.4/full.md>
